...
const COLUMNS = [
    ...
    { key: "DepositHeld", label: "Deposit Held (AED)", type: "money" },
    { key: "AdminFee", label: "Admin Fee (AED)", type: "money" },
    { key: "UtilityCharges", label: "Utility Charges (AED)", type: "money" },
    { key: "CapacityCharges", label: "Capacity Charges (AED)", type: "money" },
    { key: "BillingFee", label: "Billing Fee (AED)", type: "money" },
    { key: "LateFee", label: "Late Fee (AED)", type: "money" },
    { key: "OtherFee", label: "Other Fee (AED)", type: "money" },
    { key: "Vat5Per", label: "VAT 5% (AED)", type: "money" },
    { key: "AdvanceAmount", label: "Advance Amount (AED)", type: "money" },
    { key: "AdjustmentAmount", label: "Adjustment (AED)", type: "money" },
    { key: "Total", label: "Total (AED)", type: "total" },
];
